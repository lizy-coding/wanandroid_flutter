class NaviEntity {
  ...
  NaviEntity({List<NaviData>? data, this.errorCode, this.errorMsg}) {
    if (data != null) {
      this.data = data;
    }
  }
...
class NaviData {
  ...
  NaviData({this.name, List<NaviDataArticle>? articles, this.cid}) {
    if (articles != null) {
  ...
  NaviData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['articles'] != null) {
      (json['articles'] as List).forEach((v) {
        articles.add(NaviDataArticle.fromJson(v));
      });
    }
    cid = json['cid'];
  }
